...
#include <memory>
#include "../../test_map/markermodel.h"
...
QT_MOC_LITERAL(3, 23, 14), // "QGeoCoordinate"
QT_MOC_LITERAL(4, 38, 10) // "coordinate"

    },
    "MarkerModel\0addMarker\0\0QGeoCoordinate\0"
    "coordinate"
};
...
void MarkerModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->addMarker((*reinterpret_cast< const QGeoCoordinate(*)>(_a[1]))); break;
        default: ;
        }
